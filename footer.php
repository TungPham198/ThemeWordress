						...
						<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
							<div class="box-footer info-contact">
								...
								<div class="content-list">
									<ul>
										<li><a href="<?php bloginfo('stylesheet_directory'); ?>/#"><i class="fa fa-angle-double-right"></i> Chính sách bảo mật</a></li>
										<li><a href="<?php bloginfo('stylesheet_directory'); ?>/#"><i class="fa fa-angle-double-right"></i> Chính sách đổi trả</a></li>
										<li><a href="<?php bloginfo('stylesheet_directory'); ?>/#"><i class="fa fa-angle-double-right"></i> Phí vẫn chuyển</a></li>
										<li><a href="<?php bloginfo('stylesheet_directory'); ?>/#"><i class="fa fa-angle-double-right"></i> Hướng dẫn thanh toán</a></li>
										<li><a href="<?php bloginfo('stylesheet_directory'); ?>/#"><i class="fa fa-angle-double-right"></i> Chương trình khuyến mãi</a></li>
									</ul>
								</div>
							</div>
						</div>
		...
		<div id="fb-root"></div>
		<script async defer crossorigin="anonymous" src="<?php bloginfo('stylesheet_directory'); ?>/https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v6.0"></script>
        <?php wp_footer(); ?>
	</body>
</html>